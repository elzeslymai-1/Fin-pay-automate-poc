...
describe('Setting Custom Network Page', () => {

    // Custom Network Page Test Scenario
    describe('', () => {
        beforeAll(async () => {
            // before
        ...
        beforeEach(async () => {
            AllureReporter.addSubSuite('Custom Network Page Test Scenario')   // add sub suite for allure report
        })
    ...
    // Add Custom Network Page Test Scenario
    describe('', () => {
        beforeEach(async () => {
            AllureReporter.addSubSuite('Add Custom Network Page Test Scenario')   // add sub suite for allure report
        })
    ...
    // Add Network Success Test Scenario
    describe('', () => {
        beforeAll(async () => {
        ...
        beforeEach(async () => {
            AllureReporter.addSubSuite('Add Network Success Test Scenario')   // add sub suite for allure report
        })
    ...
    // Remove Chain Modal Test Scenario
    describe('', () => {
        beforeAll(async () => {
            await action.click(component.homeTabSettingBtn)     // go to setting page
            await action.click(component.settingNetworkManageBtn)   // go to network management
        ...
        beforeEach(async () => {
            AllureReporter.addSubSuite('Remove Chain Modal Test Scenario')   // add sub suite for allure report
        })
