...
describe('Request Camera Permission Modal Test Scenario', () => {
    beforeAll(async () => {
...
describe('Deny Camera Permission Test Scenario', () => {
...
describe('Request Photo Permission Modal Test Scenario', () => {
    beforeAll(async () => {
        await action.installApps('apps/FinPay.app')     // install apps
        await action.launchApps(`${process.env.BUNDLE_ID}`)     //launch app
...
describe('Deny Photo Permission Test Scenario', () => {
    it('[Display] => Check OK Btn', async () => {
        // assert
