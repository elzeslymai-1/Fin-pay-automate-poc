export class backUpComponent {
    ...
    backupRememberPhraseText = `android=new UiSelector().text("Remember to record your words in the same order as they appear below.").className("android.widget.TextView")`
